...
const styles = StyleSheet.create({
  ...
  iconBtnText: { color: "#0F172A", fontWeight: "800", fontSize: 13 },
  ...
  toggleThumbActive: { backgroundColor: WaiterColors.primary },
  toggleLabel: { fontSize: 13, color: "#64748B", fontWeight: "600" },
  toggleLabelActive: { color: WaiterColors.primary, fontWeight: "700" },
});
