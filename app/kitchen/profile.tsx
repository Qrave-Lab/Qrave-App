    ...
    >
      <View style={styles.accordionHeaderLeft}>
        <MaterialIcons
          name={icon}
          size={24}
          color={isExpanded ? KitchenColors.primary : "#475569"}
...
export default function KitchenProfile() {
  ...
  return (
    <View style={styles.container}>
      <KitchenWavyHeader height={140} title="Profile" subtitle="" />

      <ScrollView
        contentContainerStyle={styles.scrollContent}
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor={KitchenColors.primary} />
        }
      >
        {loading ? (
          <View style={styles.loadingBox}>
            <ActivityIndicator size="small" color={KitchenColors.primary} />
          </View>
        ) : error ? (
...
const styles = StyleSheet.create({
  ...
  accordionCardActive: {
    borderColor: KitchenColors.primary,
    borderWidth: 1.5,
  },
  accordionHeader: {
    flexDirection: "row",
