...
export function withLogoVersion(url: string | null | undefined, version: string | null | undefined): string | null {
...
export async function getStoredLogoVersion(): Promise<string> {
  try {
...
export async function bumpLogoVersion(): Promise<string> {
